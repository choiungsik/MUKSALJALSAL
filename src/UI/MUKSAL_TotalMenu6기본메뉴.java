...
public class MUKSAL_TotalMenu6기본메뉴 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MUKSAL_TotalMenu6기본메뉴 window = new MUKSAL_TotalMenu6기본메뉴();
	...
	private void initialize() {
		...
		JLabel label_스테이크 = new JLabel("\uCE74\uD14C\uACE0\uB9AC");
		label_스테이크.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
		...
		label_스테이크.setHorizontalAlignment(SwingConstants.CENTER);
		label_스테이크.setBounds(174, 0, 78, 54);
		panel_6.add(label_스테이크);
		...
		JLabel label_기본메뉴 = new JLabel("\uAE30\uBCF8\uBA54\uB274!");
		...
		label_11.setBounds(12, 10, 207, 347);
